document.getElementById('calc-form').addEventListener('submit', function (e) {
 ...
 // คำนวณ BMR
    ...
    // Display Results
    document.getElementById('bmr-result').textContent = `BMRอัตราการใช้พลังงานขั้นพื้นฐาน: ${bmr.toFixed(2)} แคลอรี/วัน`;
    document.getElementById('tdee-result').textContent = `TDEEอัตราการใช้พลังงานต่อวันโดยรวม: ${tdee.toFixed(2)} แคลอรี/วัน`;
